...
def _draw_labels(image, heading_text, x_axis_text, y_axis_text):
    ...
    # heading_font = ImageFont.truetype('FreeSans.ttf', 32)
    axis_font = ImageFont.truetype('arial.ttf', 16)
    # axis_font = ImageFont.truetype('FreeSans.ttf', 16)
...
def _draw_y_axes(image, border_width, y_axis_start, y_axis_end, y_axis_interval):
    ...
    index_font = ImageFont.truetype('arial.ttf', 12)
